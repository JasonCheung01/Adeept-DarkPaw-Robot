...
while(True):
	...
	try:  
		...
		# Code below tracks the line by analyzing two pixels in parallel and utilizes the information it detects 
		# x coordinate of starting and ending are always changing 
